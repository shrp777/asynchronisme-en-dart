...
void main() async {
  ...
  test(
    """La méthode factory de User doit retourner un objet User à partir d'une map simulant une valeur JSON""",
  ...
  test(
    """La méthode factory de User doit retourner un objet User à partir d'une map simulant une valeur JSON même si des valeurs sont nulles""",
  ...
  test(
    """La méthode sayHello de User doit retourner "Hello, my name is John Doe" """,
